...
function UpdateCustomerAddress(ncUtil, channelProfile, flowContext, payload, callback) {
    const stub = new nc.Stub("UpdateCustomerAddress", ...arguments);
...
async function putCustomerAddress(stub) {
    nc.logInfo("Putting customer address...");
